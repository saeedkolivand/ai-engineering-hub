...
//   node .claude/hooks/lessons.mjs query [--domain ingestion|analytics|contracts|streamdeck|security|frontend|rust|testing] [--category X] [--text "..."] [--limit 8]
...
const DOMAIN_CATEGORIES = {
  ingestion: ['Ingestion', 'Performance', 'Architecture decision'],
  analytics: ['Analytics', 'Performance'],
  contracts: ['Contracts', 'Architecture decision'],
  streamdeck: ['Plugin', 'Contracts'],
  security: ['Security'],
  frontend: ['Proven approach', 'Performance'],
...
Usage:
  ...
  query  [--domain ingestion|analytics|contracts|streamdeck|security|frontend|rust|testing] [--category X] [--text "..."] [--limit 8]
